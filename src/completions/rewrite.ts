...
export const GENERATE_SYSTEM_PROMPT =
    ...
    "Output ONLY the text to insert — no explanations, no meta-text, no markers. Preserve markdown formatting. Write in Markdown: keep headings as headings, put each numbered list item on its own line, and always start a new line after a heading before body text. Default to a short paragraph (3-5 sentences) unless the instruction asks for more.";
