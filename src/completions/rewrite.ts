...
export const REWRITE_SYSTEM_PROMPT =
    ...
    "Output ONLY the rewritten text for the selected part — no explanations, no meta-text, no markers. Preserve markdown formatting. Keep the original language unless the instruction says otherwise.";
